...
namespace _06_Arrays
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //Console.WriteLine(numbers[5]); // 5. index'e atama yapılmadığı için default değer olan 0 gelir.
            ...
            //int[] numbers = { 45, 85, 52, 41, 86, 10, 22, 35 };
            //Array.Reverse(numbers); // tersten sıralar
            //for (int i = 0; i < numbers.Length; i++)
            //{
            //    Console.WriteLine(numbers[i]);
            //}
            ...
            int[] numbers = { 21, 42, 33, 54, 55, 66, 897, 748, 39, 20 };
